...
public class RomanNumeralToArabicNumberConverterTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		romanNumeralToArabicNumberConverter = new RomanNumeralToArabicNumberConverter(romanNumeralValidator);
	}
	...
	public void testGetRomanNumeralValidator() throws Exception {
		assertSame(romanNumeralValidator, romanNumeralToArabicNumberConverter.getRomanNumeralValidator());
	}
	...
	public void testConvert_CanConvertNumeralsLessThanC() throws Exception {
		...
		String[] expectedArabicNumbers = {"2","4","6","8","9","14","33","41","44",
				"49","54","80","87","94","99"};
	...
	public void testConvert_CanConvertNumeralsLessThanD() throws Exception {
		...
		String[] expectedArabicNumbers = {"100","144","165","208","249","314","333",
				"341","445","449","454","480","487","494","499"};
	...
	public void testConvert_CanConvertNumeralsLessThanM() throws Exception {
		...
		String[] expectedArabicNumbers = {"500","544","565","608","749","814","833",
				"841","945","949","954","980","987","994","999"};
	...
	public void testConvert_CanConvertUpToMMMCMXCIX(){
		...
		String[] expectedArabicNumbers = {"1300","1444","1965","1999","2015","2222","2738","3001","3333",
				"3450","3954","3980","3987","3994","3999"};
	...
	public void testConvert_ReturnsInvalidInputIfInputIsNotValidRomanNumeral() throws Exception {
		String expectedValue = "Invalid Input";
		
		assertEquals(expectedValue, romanNumeralToArabicNumberConverter.convertToArabicNumber(""));
		assertEquals(expectedValue, romanNumeralToArabicNumberConverter.convertToArabicNumber("MMMMMMMMM"));
		assertEquals(expectedValue, romanNumeralToArabicNumberConverter.convertToArabicNumber("DONUTS"));
	}
}
